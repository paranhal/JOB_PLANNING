...
CREATE TABLE IF NOT EXISTS customers (
    ...
    addr_sido          VARCHAR(50),
    addr_sigungu       VARCHAR(100),
    addr_dong          VARCHAR(100),
    is_active          BOOLEAN      DEFAULT TRUE,
    notes              TEXT,
    created_at         TIMESTAMP    DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS assets (
    ...
    maint_contract_type VARCHAR(50),
    maint_cycle         VARCHAR(50),
    maint_start_date    DATE,
    maint_end_date      DATE,
    maint_billing_party VARCHAR(200),
    maint_billing_cycle VARCHAR(200),
