...
| 담당자직급 | 직렬·직급 구분 | 사서직, 전산직, 기타, 직접입력 |
...
| 유지보수점검주기 | 방문·대응 주기 | 월, 분기, 반기, 홀수격월, 짝수격월, 직접입력(청구주기와 동일) |
| 유지보수청구주기 | 청구 시점 | 월, 분기, 반기, 홀수격월, 짝수격월, 직접입력 |
...
| job_grade | string | N | 직급(사서직/전산직/기타 코드 또는 직접입력 문구) |
| phone | string | N | 전화번호 |
...
| maint_cycle_code | string | N | 점검주기(월/분기/반기/홀수격월/짝수격월 코드 또는 직접입력 문구, 청구주기와 동일) |
| maint_start_date | date | N | 계약 시작일 |
| maint_end_date | date | N | 계약 종료일 |
| maint_billing_party | string | N | 청구처 |
| maint_billing_cycle | string | N | 청구주기(월/분기/반기/홀수격월/짝수격월 코드 또는 직접입력 문구) |
